...
import static com.meichinijiuchiquba.pnwebrtc.PnRTCMessage.JSON_MESSAGE_GROUP_ID;
import static com.meichinijiuchiquba.pnwebrtc.PnRTCMessage.JSON_SENDER_GENDER;
import static com.meichinijiuchiquba.pnwebrtc.PnRTCMessage.JSON_SENDER_NICK_NAME;
...
public class PnPeerConnectionClient {
    ...
    private void init() {
        ...
        // Note: this no longer builds with latest PN
...
//        }
     ...
     * a {@link com.meichinijiuchiquba.pnwebrtc.PnRTCClient} instantiated. Simply send a publish with the
    ...
    // Note: This no longer builds, won't compile with latest pn
